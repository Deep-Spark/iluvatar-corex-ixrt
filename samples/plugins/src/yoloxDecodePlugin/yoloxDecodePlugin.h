...
class YoloxDecoder : public IPluginV2DynamicExt {
   public:
    YoloxDecoder(int32_t num_class, int32_t stride);
    YoloxDecoder(void const* data, size_t length);
    YoloxDecoder() noexcept = delete;
    ~YoloxDecoder() override = default;
   ...
   private:
    ...
    void validateAttributes(int32_t num_class, int32_t stride);
...
class YoloxDecoderPluginCreator : public IPluginCreator {
   public:
    YoloxDecoderPluginCreator();

    ~YoloxDecoderPluginCreator() override = default;
