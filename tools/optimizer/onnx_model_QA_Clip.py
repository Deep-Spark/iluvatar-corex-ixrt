...
from passes.fusion_QA_Clip_splitQKV_attention import FusionSplitQKVWithAtten
...
class QAClipOnnxModel(OnnxModel):
    ...
    def fuse_attention(self):
        fusion = FusionSplitQKVWithAtten(self,self.num_heads,self.hidden_size)
        fusion.apply()
